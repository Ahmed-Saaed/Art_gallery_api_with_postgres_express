...
describe("Orders Model", function () {
    ...
    it('is an addProduct method that should add product to gallery_order', function () { return __awaiter(void 0, void 0, void 0, function () {
        var result;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, store.addProduct(3, 1, 1)];
                case 1:
                    result = _a.sent();
                    expect(result).toEqual({
                        quantity: 3,
