...
var Orders = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("cannot get the Order ".concat(err_1));
    ...
    Orders.prototype.addProduct = function (quantity, ArtId, orderId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                        sql = 'INSERT INTO gallery_order (quantity, art_id, order_id) VALUES($1, $2, $3) RETURNING *';
                        return [4 /*yield*/, database_1.default.connect()];
                    case 1:
                        conn = _a.sent();
                        return [4 /*yield*/, conn
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not add Art piece ".concat(ArtId, " to order ").concat(orderId, ": ").concat(err_4));
                    case 4: return [2 /*return*/];
                }
            });
        });
