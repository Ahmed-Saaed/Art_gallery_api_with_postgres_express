...
var gallery = /** @class */ (function () {
    ...
    gallery.prototype.index = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("cannot get the ArtPiece ".concat(err_1));
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_2 = _a.sent();
                        throw new Error("Could not find ArtPiece ".concat(id, ". Error: ").concat(err_2));
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    gallery.prototype.create = function (b) {
        return __awaiter(this, void 0, void 0, function () {
            var sql, conn, result, ArtPiece, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new ArtPiece ".concat(b.title, "}. Error: ").concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
